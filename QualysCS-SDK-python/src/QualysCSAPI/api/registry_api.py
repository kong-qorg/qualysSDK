...
class RegistryApi(object):
    ...
    def cancel_bulk_cs_registry_schedules(self, registry_id, **kwargs):  # noqa: E501
        """Cancel multiple registry schedules in your account.  # noqa: E501

        Cancel multiple registry schedules in your account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cancel_bulk_cs_registry_schedules(registry_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str registry_id: Provide the ID/UUID of the registry you want to cancel the schedules for. (required)
        :param list[str] schedule_ids: Provide the ID/UUID of the schedules you want to cancel. You can only cancel schedules which are in the state: Created, Queued, Paused, Running, BaselineQueued or BaselineRunning
        :param str filter: Cancel the schdules from filter
        :return: str
        ...
        if kwargs.get('async_req'):
            return self.cancel_bulk_cs_registry_schedules_with_http_info(registry_id, **kwargs)  # noqa: E501
        else:
            (data) = self.cancel_bulk_cs_registry_schedules_with_http_info(registry_id, **kwargs)  # noqa: E501
            return data

    def cancel_bulk_cs_registry_schedules_with_http_info(self, registry_id, **kwargs):  # noqa: E501
        """Cancel multiple registry schedules in your account.  # noqa: E501

        Cancel multiple registry schedules in your account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cancel_bulk_cs_registry_schedules_with_http_info(registry_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['registry_id', 'schedule_ids', 'filter']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method cancel_bulk_cs_registry_schedules" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('registry_id' not in params or
            ...
            raise ValueError("Missing the required parameter `registry_id` when calling `cancel_bulk_cs_registry_schedules`")  # noqa: E501
        ...
        if 'schedule_ids' in params:
            query_params.append(('scheduleIds', params['schedule_ids']))  # noqa: E501
            collection_formats['scheduleIds'] = 'multi'  # noqa: E501
        if 'filter' in params:
        ...
        return self.api_client.call_api(
            '/registry/{registryId}/schedule/cancel', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def cancel_cs_registry_schedule(self, registry_id, schedule_id, **kwargs):  # noqa: E501
        ...
        :param str schedule_id: Provide the ID/UUID of the schedule you want to cancel. You can only cancel schedules which are in the state: Created, Queued, Paused, Running, BaselineQueued or BaselineRunning (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def create_cs_aws_connector(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param AwsConnectorRequest body: Provide parameter values in the format shown under Example Value. Specify accountType either Global or US_Gov. (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def delete_bulk_schedules(self, registry_id, **kwargs):  # noqa: E501
        """Delete bulk registry schedules in your account.  # noqa: E501

        Delete bulk registry schedules in your account. You can only delete the schedules which are in state: Finished, Error, Failed, Canceled. If both scheduleIds and filter are provided, deletion will be performed using scheduleIds.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_bulk_schedules(registry_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str registry_id: Provide the ID/UUID of the registry you want to delete the schedules for. (required)
        :param list[str] schedule_ids: Provide the ID/UUID of the schedules you want to delete.
        :param str filter: Delete the schedules using filter query. All the schedules matching the filter query will be deleted.
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_bulk_schedules_with_http_info(registry_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_bulk_schedules_with_http_info(registry_id, **kwargs)  # noqa: E501
            return data

    def delete_bulk_schedules_with_http_info(self, registry_id, **kwargs):  # noqa: E501
        """Delete bulk registry schedules in your account.  # noqa: E501

        Delete bulk registry schedules in your account. You can only delete the schedules which are in state: Finished, Error, Failed, Canceled. If both scheduleIds and filter are provided, deletion will be performed using scheduleIds.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_bulk_schedules_with_http_info(registry_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_bulk_schedules" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'registry_id' is set
        if ('registry_id' not in params or
                params['registry_id'] is None):
            raise ValueError("Missing the required parameter `registry_id` when calling `delete_bulk_schedules`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/registry/{registryId}/schedule/bulk', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_cs_registries(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param list[str] registry_ids: delete the registries from uuid
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def delete_cs_registries_with_http_info(self, **kwargs):  # noqa: E501
        ...
        query_params = []
        if 'registry_ids' in params:
            query_params.append(('registryIds', params['registry_ids']))  # noqa: E501
            collection_formats['registryIds'] = 'multi'  # noqa: E501
    ...
    def delete_cs_registry_schedules(self, registry_id, **kwargs):  # noqa: E501
        ...
        :param list[str] schedule_ids: delete the schedules from uuid
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_cs_aws_gov_account_id_using_get(self, **kwargs):  # noqa: E501
        """Fetch AWS Gov account ID and external ID for your account  # noqa: E501

        Fetch AWS Gov account ID and external ID for your account  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cs_aws_gov_account_id_using_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_cs_aws_gov_account_id_using_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_cs_aws_gov_account_id_using_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_cs_aws_gov_account_id_using_get_with_http_info(self, **kwargs):  # noqa: E501
        """Fetch AWS Gov account ID and external ID for your account  # noqa: E501

        Fetch AWS Gov account ID and external ID for your account  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cs_aws_gov_account_id_using_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_cs_aws_gov_account_id_using_get" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def update_cs_registry(self, body, registry_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param RegistryRequest body: Provide parameter values in the format shown under Example Value. Specify accountType either Global or US_Gov. registryType and registryUri are required even though they are not updatable. (required)
